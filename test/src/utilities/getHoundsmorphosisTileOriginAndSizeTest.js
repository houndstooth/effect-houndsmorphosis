	...
	describe('when x is negative and y is positive', () => {
		describe('first row', () => {
			...
			it('is shifting leftwards, by 1 more each time, starting at -1, starting with a move of 2', () => {
				expect(subject({ gridAddress: [ -1, 1 ] }).tileOrigin[ 0 ]).toEqual(-1)
				expect(subject({ gridAddress: [ -2, 1 ] }).tileOrigin[ 0 ]).toEqual(-3)
				expect(subject({ gridAddress: [ -3, 1 ] }).tileOrigin[ 0 ]).toEqual(-6)
				expect(subject({ gridAddress: [ -4, 1 ] }).tileOrigin[ 0 ]).toEqual(-10)
			})
		...
		describe('second row', () => {
			...
			it('is shifting leftwards, by 1 more each time, starting at -1, starting with a move of 2', () => {
				expect(subject({ gridAddress: [ -1, 2 ] }).tileOrigin[ 0 ]).toEqual(-1)
				expect(subject({ gridAddress: [ -2, 2 ] }).tileOrigin[ 0 ]).toEqual(-3)
				expect(subject({ gridAddress: [ -3, 2 ] }).tileOrigin[ 0 ]).toEqual(-6)
				expect(subject({ gridAddress: [ -4, 2 ] }).tileOrigin[ 0 ]).toEqual(-10)
			})
		...
		describe('third row', () => {
			...
			it('is shifting leftwards, by 1 more each time, starting at -2, starting with a move of 3', () => {
				expect(subject({ gridAddress: [ -1, 3 ] }).tileOrigin[ 0 ]).toEqual(-2)
				expect(subject({ gridAddress: [ -2, 3 ] }).tileOrigin[ 0 ]).toEqual(-5)
				expect(subject({ gridAddress: [ -3, 3 ] }).tileOrigin[ 0 ]).toEqual(-9)
				expect(subject({ gridAddress: [ -4, 3 ] }).tileOrigin[ 0 ]).toEqual(-14)
			})
		...
		describe('fourth row', () => {
			...
			it('is shifting leftwards, by 1 more each time, starting at -2, starting with a move of 3', () => {
				expect(subject({ gridAddress: [ -1, 4 ] }).tileOrigin[ 0 ]).toEqual(-2)
				expect(subject({ gridAddress: [ -2, 4 ] }).tileOrigin[ 0 ]).toEqual(-5)
				expect(subject({ gridAddress: [ -3, 4 ] }).tileOrigin[ 0 ]).toEqual(-9)
				expect(subject({ gridAddress: [ -4, 4 ] }).tileOrigin[ 0 ]).toEqual(-14)
			})
	...
	describe('when x is positive and y is negative', () => {
		describe('first row', () => {
			...
			it('is shifting upwards, by 1 each time, starting at -1', () => {
				expect(subject({ gridAddress: [ 1, -1 ] }).tileOrigin[ 1 ]).toEqual(-1)
				expect(subject({ gridAddress: [ 2, -1 ] }).tileOrigin[ 1 ]).toEqual(-2)
				expect(subject({ gridAddress: [ 3, -1 ] }).tileOrigin[ 1 ]).toEqual(-3)
				expect(subject({ gridAddress: [ 4, -1 ] }).tileOrigin[ 1 ]).toEqual(-4)
			})
		})
		...
		describe('second row', () => {
			...
			it('is shifting upwards, by 1 each time, starting at -2', () => {
				expect(subject({ gridAddress: [ 1, -2 ] }).tileOrigin[ 1 ]).toEqual(-2)
				expect(subject({ gridAddress: [ 2, -2 ] }).tileOrigin[ 1 ]).toEqual(-3)
				expect(subject({ gridAddress: [ 3, -2 ] }).tileOrigin[ 1 ]).toEqual(-4)
				expect(subject({ gridAddress: [ 4, -2 ] }).tileOrigin[ 1 ]).toEqual(-5)
			})
		})
		...
		describe('third row', () => {
			...
			it('is shifting upwards, by 2 each time, starting at -4', () => {
				expect(subject({ gridAddress: [ 1, -3 ] }).tileOrigin[ 1 ]).toEqual(-4)
				expect(subject({ gridAddress: [ 2, -3 ] }).tileOrigin[ 1 ]).toEqual(-6)
				expect(subject({ gridAddress: [ 3, -3 ] }).tileOrigin[ 1 ]).toEqual(-8)
				expect(subject({ gridAddress: [ 4, -3 ] }).tileOrigin[ 1 ]).toEqual(-10)
			})
		})
		...
		describe('fourth row', () => {
			...
			it('is shifting upwards, by 2 each time, starting at -6', () => {
				expect(subject({ gridAddress: [ 1, -4 ] }).tileOrigin[ 1 ]).toEqual(-6)
				expect(subject({ gridAddress: [ 2, -4 ] }).tileOrigin[ 1 ]).toEqual(-8)
				expect(subject({ gridAddress: [ 3, -4 ] }).tileOrigin[ 1 ]).toEqual(-10)
				expect(subject({ gridAddress: [ 4, -4 ] }).tileOrigin[ 1 ]).toEqual(-12)
			})
		})
	})
